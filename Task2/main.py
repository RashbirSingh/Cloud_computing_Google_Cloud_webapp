...
FROM `s3810585assignment1.gsquarterlySeptember20.gsquarterlySeptember20`
...
AS result2
FULL JOIN `s3810585assignment1.country_classification.country_classification`
ON `s3810585assignment1.country_classification.country_classification`.country_code = result2.country_code
...
FROM `s3810585assignment1.services_classification.services_classification`
,
